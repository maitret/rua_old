                            ...
                            [
                                {
                                    ...
                                    onClick: function () {
                                        ...
                                        $.when(global.createProject({ template: "standard" }),
                                                    getDataUri("/Content/pregenerated/standard/about.png"),
                                                    getDataUri("/Content/pregenerated/standard/addIncident.png"),
                                                    getDataUri("/Content/pregenerated/standard/incident.png"),
                                                    getDataUri("/Content/pregenerated/standard/incidents.png"))
                                            .done(function (project, imgAbout, imgAddIncident, imgIncident, imgIncidents) {
                                                AppDesigner.utils.viewPreview("about", project.JsonUrl, imgAbout);
                                                AppDesigner.utils.viewPreview("addIncident", project.JsonUrl, imgAddIncident);
                                                AppDesigner.utils.viewPreview("incident", project.JsonUrl, imgIncident);
                                                AppDesigner.utils.viewPreview("incidents", project.JsonUrl, imgIncidents);
                        ...
                        DX.ui.dialog.confirm("Are you sure you want to delete current project?", "Delete Project")
                            .then(function (dialogResult) {
                                if (dialogResult) {
                                    ...
                                    global.deleteProject({ jsonUrl: jsonUrl })
